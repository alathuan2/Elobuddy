...
namespace MissFortune
{
    class MissFortune
    {
        ...
        public static void Load(EventArgs args)
        {
            ...
            MissFortunMainMenuSettings = MainMenu.AddMenu("MF", "mf");
            ...
            MainMenuSettings.Add("harassQ", new CheckBox("Q on minion"));
            MainMenuSettings.Add("killQ", new CheckBox("Q only if can kill minion", false));
            MainMenuSettings.Add("qMinionMove", new CheckBox("Don't use if minions move"));
