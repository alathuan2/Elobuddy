...
namespace Jinx
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Chat.Print("Jinx Loaded!");
        }

        private static void LoadMenu()
        {
            JinxMenu = MainMenu.AddMenu("DrJinx", "jinx");
            ...
            SpellsMenu.Add("farmQout", new CheckBox("Q Lasthit if out range Attack"));
            ...
            SpellsMenu.Add("comboE", new CheckBox("Auto E"));
            SpellsMenu.Add("autoE", new CheckBox("E on CC"));
            SpellsMenu.Add("AGC", new CheckBox("AntiGap E"));
            ...
            SpellsMenu.Add("autoR", new CheckBox("Auto R Incomplete"));
            SpellsMenu.Add("useR",
                new KeyBind("Cast R key", false, KeyBind.BindTypes.HoldActive, "T".ToCharArray()[0]));
            ...
            JungleStealMenu.Add("Rjungle", new CheckBox("R Jungle Steal"));
            ...
            PredictionMenu.Add("Rpred", new Slider("R Hitchance", 79));
        }
