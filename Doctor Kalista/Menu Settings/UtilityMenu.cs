...
namespace MarksmanAIO
{
    public static class UtilityMenu
    {
        ...
        public static void Init()
        {
            try
            {
                _menu = EloBuddy.SDK.Menu.MainMenu.AddMenu("Kalista Utility", "marks.aio.utility.menu",
                    Player.Instance.ChampionName);
                _menu.AddGroupLabel("Kalista Utilities for " + Player.Instance.ChampionName);
                Activator.Init();
                BaseUltMenu();
            }
            catch (Exception e)
        ...
        public static void ActivatorMenu()
        {
            ...
            _activator.AddGroupLabel("Kalista - Activator for " + Player.Instance.ChampionName,
        ...
        public static void BaseUltMenu()
        {
            ...
            _baseult.AddGroupLabel("Kalista - BaseULT for " + Player.Instance.ChampionName,
