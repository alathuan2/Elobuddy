...
namespace Kalista
{
    internal class Activator
    {
        ...
        {
            if (KalistaMenu.GetBoolValue(KalistaMenu.ActivatorSettings, "use.botrk.cutlass") &&
                Player.Instance.HealthPercent <=
                KalistaMenu.GetSliderValue(KalistaMenu.ActivatorSettings, "botrk.cutlass.health"))
            {
            ...
            if (KalistaMenu.GetBoolValue(KalistaMenu.ActivatorSettings, "use.youmuu") && Youmuu.IsOwned() &&
