...
namespace Kalista.Utility.SkinManager
{
    public class SkinManagement : UtilityAddon
    {
        ...
        {
            Menu.AddGroupLabel("Kalista - Skinmanager for " + Player.Instance.ChampionName,
            ...
            using (
                var infoStream =
                    Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Kalista.Utility.SkinManager.SkinInfo.xml"))
